                ...
                () => TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: UnderlineInputBorder(
                      borderSide: BorderSide(
                          color: controller.SelectedColor.value!, width: 2.0),
                    ),
          ...
          Container(
            ...
            child: Center(
              child: ElevatedButton(
                onPressed: () {
                  if (controller.SelectedEmojis.isEmpty ||
                      controller.CategoryTitleController.value.text.isEmpty) {
                    ...
                    Category newCategory =
                        Category(title: title, them: them, icon: icon);
