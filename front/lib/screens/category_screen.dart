...
class Category_screen extends StatelessWidget {
    ...
    return Container(
      child: Column(
        ...
        children: [
          ...
          // EmojisList()
          Obx(() =>
              controller.ColorsState.value ? CirleList(context) : Container()),
  ...
  Widget buildGridCategorie(BuildContext context) {
    return Container(
      height:
          MediaQuery.of(context).size.height * 0.7, // Set the height as needed
      child: GridView.builder(
          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
              crossAxisCount: 2,
              crossAxisSpacing: 2,
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              title!,
              style: const TextStyle(fontSize: 14.0, fontFamily: 'Heebo-Bold'),
            ),
          ),
          Container(
            child: const Text(
              '10 Tasks',
              style: const TextStyle(fontSize: 12.0, fontFamily: 'Heebo-Bold'),
            ),
          ),
        ],
      ),
